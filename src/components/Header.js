  ...
  return (
        ...
        <div className=' bg-black flex flex-row mx-auto px-3 pb-1 justify-between items-center  overflow-hidden  '>                                          
            ...
            <IconStyle className=' w-full-screen'>
                 ...
                 <HoverButton >
                <button onClick={handleAuth}  className=' justify-end tracking-widest bg-black border-2 border-gray-500 text-white  mr-4 px-5 py-2 rounded-md uppercase '>Login</button>
                </HoverButton>
                </div>
                    ...
                    <img src={logo} alt='logo' className=' h-12 ml-8 mb-4 flex  lg:hidden' />
                    
                <div className=' text-white list-none  items-center  max-w-3xl  hidden lg:flex mt-1 space-x-5 text-center  w-full-screen   ' id='header'>            
                ...
                <img src={logo} alt='logo' className=' h-12 ml-8 mb-4  ' />
                  ...
                  <span className="material-symbols-outlined text-md  ">home</span>                                   
                    ...
                    <a href='#search' className=' text-sm '>Search</a>               
                    </div>


                    <div className='flex '>                
                    <span className="material-symbols-outlined text-md ">add</span>                
                    <a href='#watchLists' className=' text-sm '>WatchLists</a>                
                    </div>


                    <div className='flex '>
                    <span className="material-symbols-outlined text-md ">star</span>               
                    <a href='#originals' className=' text-sm '>Originals</a>              
                    </div>

                    <div className='flex '>
                    <span className="material-symbols-outlined text-md ">movie</span>               
                    <a href='#movies' className=' text-sm '>Movies</a>                
                    </div>

                    <div className='flex '>
                    <span className="material-symbols-outlined text-md ">tv</span>                
                    <a href='#series' className=' text-sm '>Series</a>              
                    </div>
                    ...
                    <button onClick={ ()=> setSideMenuStatus(true) }  style={{display: SideMenuStatus ? 'none' : 'block' }}>
                    ...
                    <button onClick={ ()=> setSideMenuStatus(false) } style={{display: SideMenuStatus ? 'block' : 'none' }}   >
                    ...
                    <Menu show={SideMenuStatus} >
                      ...
                      <a href='#logout' className=' text-sm ' onClick={handleAuth} >Logout</a>       
                      </div>
              ...
              <Img src={profile} className="hidden">
