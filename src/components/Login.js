        ...
        <div className="flex flex-col h-login-page  justify-center  items-center  before:  ">
          ...
          <div>
            <p className="text-white text-sm mt-5 max-w-xl opacity-80 text-center">
              ...
              fits you best for a discounted price. You can save 25%, compared
              to the monthly cost of subscribing to all 3 services separately!
              Choose between The Disney Bundle with Hulu (ad-supported) for
              $13.99/month or with Hulu (No Ads) for $19.99/month.
            </p>
          </div>
